...
<div class="container" style="margin-top:200px">
    <div class="row text-center">
        <div class="col-lg-4">
            <i class="fas fa-sitemap mb-3" style="font-size:50px;color:#d19c34;"></i>
            <h4>Number Team</h4>
            <h1>4</h1>
        </div>
        <div class="col-lg-4">
            <i class="fas fa-users mb-3" style="font-size:50px;color:#d19c34"></i>
            <h4>Number User</h4>
            <h1>{{$users}}</h1>
        </div>
        <div class="col-lg-4">
            <i class="far fa-envelope mb-3" style="font-size:50px;color:#d19c34"></i>
